...
in {
  ...
  config = mkIf cfg.enable (mkMerge [
    ...
    { systemd.timers.nextcloud-cron = {
      ...
      in {
        root = cfg.package;
        enableACME = mkIf cfg.https true;
        forceSSL = mkIf cfg.https true;
        locations."^~ /.well-known/acme-challange/" = mkIf cfg.https { extraConfig = "allow all; root /var/lib/acme/acme-challenge; auth_basic off; "; };
        locations = {
          "= /robots.txt" = {
            priority = 100;
            extraConfig = ''
